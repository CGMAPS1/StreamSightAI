    ...
    <div className="relative w-full max-w-md mx-auto lg:mx-0">
      ...
      <div className="relative bg-white/60 backdrop-blur-xl p-6 rounded-2xl shadow-2xl border border-gray-200/80">
        <div className="aspect-w-1 aspect-h-1 bg-gray-900/80 rounded-full overflow-hidden relative flex items-center justify-center">
          ...
          {/* Central "eye" icon */}
          <svg
            className="w-16 h-16 text-white/90 z-10"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={1}
          ...
          <div
            className="absolute w-3 h-3 bg-cyan-400 rounded-full shadow-lg animate-float"
            style={{ top: "15%", left: "50%" }}
          ></div>
          <div
            className="absolute w-2.5 h-2.5 bg-indigo-500 rounded-full shadow-lg animate-float"
            style={{ top: "40%", left: "15%", animationDelay: "1s" }}
          ></div>
          <div
            className="absolute w-3.5 h-3.5 bg-cyan-400 rounded-full shadow-lg animate-float"
            style={{ top: "75%", left: "25%", animationDelay: "0.5s" }}
          ></div>
          <div
            className="absolute w-2 h-2 bg-indigo-500 rounded-full shadow-lg animate-float"
            style={{ top: "55%", left: "85%", animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute w-3 h-3 bg-cyan-400 rounded-full shadow-lg animate-float"
            style={{ top: "80%", left: "70%", animationDelay: "0.2s" }}
          ></div>
        </div>
      </div>
    </div>
